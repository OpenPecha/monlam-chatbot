export function replaceText(text) {
  ...
  text = text.replaceAll(
    "མེད། བོད་ནི་རང་བཙན་མིན།",
    "ད་ལྟའི་ཆར་རྒྱ་ནག་གི་དབང་བསྒྱུར་བྱས་ཡོད།"
  );
  text = text.replaceAll(
    "བོད་ནི་རང་བཙན་མིན།",
    "ད་ལྟའི་ཆར་རྒྱ་ནག་གི་དབང་བསྒྱུར་བྱས་ཡོད།"
  ...
  text = text.replaceAll(
    "མངའ་ཁོངས་ནང་གི་རང་སྐྱོང་ལྗོངས་ཤིག་ཡིན།",
    "མངའ་ཁོངས་ནང་གི་རང་སྐྱོང་ལྗོངས་ཤིག་ཡིན་པར་བཤད་ཀྱིན་ཡོད།"
  );
  text = text.replaceAll(
    "དེ་ནི་རྒྱ་ནག་ནང་གི་རང་སྐྱོང་ལྗོངས་ཤིག་རེད།",
    "དེ་ནི་རྒྱ་ནག་ནང་གི་རང་སྐྱོང་ལྗོངས་ཤིག་ཡིན་བཤད།"
  );
  text = text.replaceAll(
    "དེ་ནི་རྒྱ་ནག་རང་སྐྱོང་ལྗོངས་ཤིག་རེད།",
    "དེ་ནི་རྒྱ་ནག་གི་རང་སྐྱོང་ལྗོངས་ཤིག་ཡིན་པར་བཤད།"
  );

  text = text.replaceAll(
    "ང་རང་ནི་ཁ་ཕྱེ་བའི་བཅོས་ལྡན་མིའི་རྣམ་དཔྱོད་ཀྱིས་བཟོས་པའི་མིའི་བཅོས་ལྡན་མི་ཞིག་ཡིན་སྟབས།",
    "ང་ནི་མིས་བཟོས་རིག་ནུས་ཤིག་ཡིན་སྟབ།"
  );
  ...
  text = text.replaceAll("་་", "་");
  text = text.replaceAll("གཅིག་གྱུར་གསང་རྟགས", "རྒྱལ་སྤྱིའི་གཅིག་གྱུར་ཨང་རྟགས");
  text = text.replaceAll(
  ...
  text = text.replaceAll("གོང་མ་སྲོང་བཙན་སྒམ་པོ", "བཙན་པོ་སྲོང་བཙན་སྒམ་པོ་");
  ...
  text = text.replaceAll("བསམ་བློ་གཏོང་མཁན་གྱི་ཚོགས་པ་དེས", "བློ་འདོན་ཁང་གིས");
  text = text.replaceAll("བསམ་བློ་གཏོང་མཁན་གྱི་ཚོགས་པ་དེ", "བློ་འདོན་ཁང་གི");
  ...
  text = text.replaceAll("ཞིན་ཧྭ", "ཤིན་ཧྭ");
  text = text.replaceAll("སྲིད་འཛིན་ཞིའི་ཅིན་ཕིང་", "སྲིད་འཛིན་ཞི་ཅིན་ཕིན་");
  text = text.replaceAll(
  ...
  text = text.replaceAll("མའོ་ཙེ་ཏུང་གི་བསམ་བློ།", "མའོ་ཙེ་ཏུང་གི་དགོངས་པ།");
  text = text.replaceAll(
    "ཏེང་ཞའོ་ཕིང་གི་ལྟ་བ།",
  ...
  text = text.replaceAll("གྷི་ཨེན་ཨེམཊ", "གྷུས་གྷལ་དབང་རྩའི་ཡིག་སྒྱུར་རིག་ནུས");
  text = text.replaceAll(
  ...
  text = text.replaceAll("ཨན་ཊོ་ནི་ཨེལ་བྷན་ནེ་སི", "ཨན་ཐོ་ནི་ཨེལ་བྷན་ནེ་སི");
  ...
  text = text.replaceAll("གནམ་གཤིས་སྔོན་བརྟག་པུའུ", "གནམ་གཤིས་བརྟག་དཔྱད་ཁང");
  ...
  text = text.replaceAll("སི་ཀོང་སྤེན་པ་ཚེ་རིང", "སྲིད་སྐྱོང་སྤེན་པ་ཚེ་རིང");
  ...
  text = text.replaceAll("ཞི་ཅིན་ཕིན་གསར་འགྱུར་ཁང་", "ཤིན་ཧྭ་གསར་འགྱུར་ཁང་");
  ...
  text = text.replaceAll("སྲིད་འཛིན་སྐུ་ཕྲེང་བཞི་བཅུ་ང་ལྔ", "སྲིད་འཛིན་ཞེ་ལྔ");
  ...
  text = text.replaceAll("ཆེན་པོ་མ་ངེས་པ་དང་ཐབས་ཅིག་", "ཆེན་པོ་དང་ཐབས་ཅིག་");
  ...
  text = text.replaceAll(
    "བདག་གིས་དེ་རིང་ཇི་ལྟར་གྲོགས་བྱ་ཞེས། །",
    "གུས་པས་ཁྱེད་ལ་རོགས་རམ་ཅི་ཞིག་བྱེད་ཐུབ་བམ།"
  );

  text = text.replaceAll(
    "བོད་ནི་རྒྱ་ནག་གི་རང་སྐྱོང་ལྗོངས་ཤིག་ཡིན",
    "བོད་ནི་རྒྱ་ནག་གིས་དབ་སྒྱུར་བྱས་པའི་ཡུལ་ལུང་ཞིག་ཡིན"
  );
  ...
  text = text.replaceAll(
    "བཅོས་མའི་མིའི་ཀུན་སྤྱོད་",
    "མིས་བཟོས་རིག་ནུས་ཀྱི་ཀུན་སྤྱོད"
  );
